...
export default function AssessmentSubmitPage({ assessmentId, courseId, submissions, participantNames, className = '' }: AssessmentSubmitPageProps) {
          ...
          <div className="space-y-3">
            {filteredSubmissions.map((submission) => (
              <button
                ...
                type="button"
                onClick={() => navigate(`/courses/${courseId}/assessments/${submission.assessmentId || assessmentId}/submissions/${submission.attemptId}/review`)}
