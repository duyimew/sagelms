...
export default function AssessmentResultListPage({ assessmentId, courseId, submissions, className = '' }: AssessmentResultListPageProps) {
          ...
          <div className="space-y-3">
            {submissions.map((submission) => (
              <button
                ...
                type="button"
                onClick={() => navigate(`/courses/${courseId}/assessments/${submission.assessmentId || assessmentId}/result/${submission.attemptId}`)}
