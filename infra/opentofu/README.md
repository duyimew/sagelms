...
2. Chạy `envs/devsecops/` để tạo project services, VPC, GKE, IAM/WIF, Secret Manager, CloudNativePG backup foundation, Redis và storage buckets.
...
- `kubectl`
- Checkov
- Quyền GCP đủ để tạo IAM, network, GKE, Redis, Secret Manager và GCS trong project `sagelms`
...
- CloudNativePG password không được tạo bằng OpenTofu; chỉ tạo Secret Manager metadata, value nhập ngoài state.
