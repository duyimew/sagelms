...
public class AssessmentQuestion extends BaseEntity {
    ...
    private AssessmentQuestionType type = AssessmentQuestionType.MULTIPLE_CHOICE;
    ...
    public AssessmentQuestionType getType() { return type; }
    public void setType(AssessmentQuestionType type) { this.type = type; }
